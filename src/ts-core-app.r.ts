...
/// <reference path="TSCore/App/Data/ISerializer.ts" />
...
/// <reference path="TSCore/App/Data/Serializers/DefaultSerializer.ts" />
/// <reference path="TSCore/App/Data/Serializers/JsonApiSerializer.ts" />
